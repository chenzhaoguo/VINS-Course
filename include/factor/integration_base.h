...
class IntegrationBase
{
  public:
...

    {
        ...
        noise.block<3, 3>(0, 0) = ACC_N * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(3, 3) = GYR_N * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(6, 6) = ACC_N * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(9, 9) = GYR_N * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(12, 12) = ACC_W * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(15, 15) = GYR_W * Eigen::Matrix3d::Identity();
    }
