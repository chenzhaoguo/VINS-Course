...
ax12.grid(linestyle="--")
## yaw
ax13.plot(euler_gt_time_relative, euler_gt[:,2], linestyle='--', linewidth=1.0, color='r', label='ground truth')
ax13.plot(euler_est_time_relative, euler_estimate[:,2], linestyle='-', linewidth=0.8, color='b', label='estimate')
