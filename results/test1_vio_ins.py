...
if __name__=="__main__":
    ...
    ax1.plot([traj_gt[0, 0]], [traj_gt[0, 1]], [traj_gt[0, 2]], 'o', markersize=3, color='r', label='initial&end position')
    ...
    ax21.set_ylabel('position err. [m]', fontsize=10)
    ...
    ax22.set_ylabel('position err. [m]', fontsize=10)
    ...
    ax31.set_ylabel('orientation err. [deg]', fontsize=10)
    ...
    insert_ax1.plot(euler_int_noise_x, diff_euler_int_noise_deg[:, 0], linewidth=0.8, color='r', label='roll')
    insert_ax1.plot(euler_int_noise_x, diff_euler_int_noise_deg[:, 1], linewidth=0.8, color='g', label='pitch')
    insert_ax1.plot(euler_int_noise_x, diff_euler_int_noise_deg[:, 2], linewidth=0.8, color='b', label='yaw')
    ...
    ax32.set_ylabel('orientation err. [deg]', fontsize=10)
    ...
    insert_ax2.plot(time, diff_euler[:, 0], linewidth=0.8, color='r', label='roll')
    insert_ax2.plot(time, diff_euler[:, 1], linewidth=0.8, color='g', label='pitch')
    insert_ax2.plot(time, diff_euler[:, 2], linewidth=0.8, color='b', label='yaw')
